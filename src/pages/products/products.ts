...
export class ProductsPage {
    ...
    constructor(public translate: TranslateService, public modalCtrl: ModalController, public nav: NavController, public popoverCtrl: PopoverController, public service: CategoryService, params: NavParams, public values: Values, public functions: Functions, private vibration: Vibration) {
        this.data = {};
        this.filter = {};
    ...
    ngOnInit() {
        this.translate.get(['ErrorTitle', 'LoginError']).subscribe(translations => {
