...
export class SearchPage {
    ...
    constructor(public nav: NavController, public popoverCtrl: PopoverController, public service: SearchService, public values: Values, params: NavParams, public functions: Functions, private vibration: Vibration) {
        this.filter = {};
        this.count = 10;
        this.offset = 0;
        this.values.filter = {};
