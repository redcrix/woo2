...
export class Service {
    ...
    getProducts() {
        ...
        this.http.get(this.config.setUrl('GET', '/wp-json/wc/v2/products/?', false), this.config.options).map(res => res.json()).subscribe(data => {
            this.products = data;
        });
    }
    getfeaturedProduct() {
        ...
        this.http.get(this.config.setUrl('GET', '/wp-json/wc/v2/products/?', this.filter), this.config.options).map(res => res.json()).subscribe(data => {
